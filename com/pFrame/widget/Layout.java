...
public class Layout extends Widget {
    ...
    protected Widget[][] containedWidgets;

    public void setRCNum(int x,int y){
        this.rownum=x;
        this.columnnum=y;
        this.containedWidgets = new Widget[rownum][columnnum];
    }
    ...
    public Layout(Widget parent, Position p, int rownum, int columnnum) {
        super(parent, p);
        this.setLayout(this);
        this.rownum = rownum;
        ...
        this.rowStyle = "";
        this.columnStyle = "";
        containedWidgets = new Widget[rownum][columnnum];
    ...
    public Layout(Widget parent, Position p) {
        super(parent, p);
        this.setLayout(this);
        this.rownum = 1;
        this.columnnum = 1;
    ...
    protected void autoSetPosition(Widget widget, Position p) {
    ...
    public ArrayList<Widget> getWidgetsAt(Position p) {
        ...
        for(int i=0;i<this.getRowNum();i++){
            for(int j=0;j<this.getColumnNum();j++){
                if(this.containedWidgets[i][j]!=null){
                    Widget w=this.containedWidgets[i][j];
                    if(Widget.WidgetRange.inRange(w.getPosition(), w.getWidgetWidth(), w.getWidgetHeight(), p)==true)
