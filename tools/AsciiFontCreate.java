...
public class AsciiFontCreate {
    ...
    public static void main(String[] args){
        ...
        try {
            ImageIO.write(ac.createFonts(1, ac.baseFonts()), "png", new FileImageOutputStream(new File("./resources/pFrame_2x2.png")));
            ImageIO.write(ac.createFonts(2, ac.baseFonts()), "png", new FileImageOutputStream(new File("./resources/pFrame_4x4.png")));
            ImageIO.write(ac.createFonts(3, ac.baseFonts()), "png", new FileImageOutputStream(new File("./resources/pFrame_6x6.png")));
            ImageIO.write(ac.createFonts(4, ac.baseFonts()), "png", new FileImageOutputStream(new File("./resources/pFrame_8x8.png")));
        } catch (Exception e) {
