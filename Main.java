...
public class Main {
    public static void main(String[] args) {
        ...
        PLayout layout = new PLayout(app, Position.getPosition(1, 1), 1, 2);
        ...
        for (int i = 0; i < 2; i++) {
            ...
            PGraphicView worldView = new PGraphicView(layout, Position.getPosition(1, i+1), new PGraphicScene(400,400));
            int mazeDim = 400;
